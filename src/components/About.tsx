  ...
  return (
    <section id="about" className="py-24 relative z-10">
      <div className="container mx-auto px-6 max-w-6xl">
        <FadeIn direction="up">
          <h2 className="text-4xl font-bold mb-12 tracking-wider text-center" style={{ color: 'var(--text-primary)' }}>ABOUT ME</h2>
        </FadeIn>
        
        <div className="flex flex-col md:flex-row items-center gap-12">
          <FadeIn direction="right" className="w-full md:w-1/3 flex justify-center">
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full p-1 relative overflow-hidden group" style={{
          ...
          <FadeIn direction="left" delay={0.2} className="w-full md:w-2/3">
            <div className="glass p-8 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>SOC Analyst & Penetration Tester</h3>
              <p className="text-lg leading-relaxed mb-6 font-light" style={{ color: 'var(--text-secondary)' }}>
              ...
              <p className="text-lg leading-relaxed font-light italic pl-4 py-1" style={{
