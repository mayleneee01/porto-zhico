        ...
        <FadeIn direction="up" delay={0.6}>
          <div className="mt-10 flex justify-center">
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/30 text-white font-medium uppercase tracking-widest backdrop-blur-sm transition-all duration-300 hover:scale-105"
            >
